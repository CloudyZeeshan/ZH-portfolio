    ...
    return (
      <section className="flex flex-col items-center justify-center p-6 md:p-12 bg-[#111827] text-white">
        ...
        <ul className="flex flex-wrap gap-2 md:gap-4 justify-center">
          ...
          <li className="bg-blue-500 text-white text-sm md:text-base px-3 py-1.5 md:px-4 md:py-2 rounded-lg shadow-md">Prompt Engineering & Context Engineering</li>
          <li className="bg-blue-500 text-white text-sm md:text-base px-3 py-1.5 md:px-4 md:py-2 rounded-lg shadow-md">Responsive Design</li>
        </ul>
      </section>
    );
  }