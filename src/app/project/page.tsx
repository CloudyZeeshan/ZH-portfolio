    ...
    <>
      ...
      <section className="flex flex-col items-center justify-center bg-gray-900 py-20 px-6 pt-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl">
          ...
          {/* Project 7 */}
           <Link href="https://frontend-of-todo-ten.vercel.app/" target="_blank">
            <div className="bg-gray-800 p-4 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300 cursor-pointer">
              <Image src="/project7.png" alt="Project seven" className="w-full h-56 object-cover rounded-lg mb-4" width={300} height={300}/>
              <h3 className="text-2xl text-white font-bold mb-2">Todo Task Management App</h3>
              <p className="text-gray-400">A responsive Todo application built to help users manage tasks, set priorities, and stay organized with a clean and user-friendly interface.</p>
            </div>
          </Link>

          {/* Project 8 */}
           <Link href="https://physical-ai-humanoid-robotics-omega-three.vercel.app/" target="_blank">
            <div className="bg-gray-800 p-4 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300 cursor-pointer">
              <Image src="/project8.png" alt="Project eight" className="w-full h-56 object-cover rounded-lg mb-4" width={300} height={300}/>
              <h3 className="text-2xl text-white font-bold mb-2">Physical AI & Humanoid Robotics Learning Platform</h3>
              <p className="text-gray-400">Designed and developed a responsive web platform that delivers structured learning content on Physical AI and humanoid robotics, focusing on clean UI, modular design, and an engaging user experience.</p>
            </div>
          </Link>

          {/* Project 9 */}
           <Link href="https://happy-birthday-to-18.vercel.app/" target="_blank">
            <div className="bg-gray-800 p-4 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300 cursor-pointer">
              <Image src="/project9.png" alt="Project nine" className="w-full h-56 object-cover rounded-lg mb-4" width={300} height={300}/>
              <h3 className="text-2xl text-white font-bold mb-2">Interactive Birthday Web App</h3>
              <p className="text-gray-400">Designed and built an interactive birthday web app featuring dynamic content, smooth animations, and a visually engaging interface to create a unique and memorable digital experience</p>
            </div>
          </Link>

          {/* Project 10 */}
           <Link href="https://happy-birthday-psi-red.vercel.app/" target="_blank">
            <div className="bg-gray-800 p-4 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300 cursor-pointer">
              <Image src="/project10.png" alt="Project ten" className="w-full h-56 object-cover rounded-lg mb-4" width={300} height={300}/>
              <h3 className="text-2xl text-white font-bold mb-2">Creative Birthday Celebration Website</h3>
              <p className="text-gray-400">An interactive birthday website focused on creativity, animations, and user engagement.</p>
            </div>
          </Link>

          {/* Project 11 */}
           <Link href="https://my-watches.vercel.app/" target="_blank">
            <div className="bg-gray-800 p-4 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300 cursor-pointer">
              <Image src="/project11.png" alt="Project eleven" className="w-full h-56 object-cover rounded-lg mb-4" width={300} height={300}/>
              <h3 className="text-2xl text-white font-bold mb-2">Watch Showcase Web Application</h3>
              <p className="text-gray-400">Designed and built a responsive e-commerce style frontend for showcasing watches, focusing on modern UI design, smooth interactions, and optimized user experience across devices.</p>
            </div>
          </Link>

          {/* Project 12 */}
           <Link href="https://milestone4by-zeeshan.vercel.app/" target="_blank">
            <div className="bg-gray-800 p-4 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300 cursor-pointer">
              <Image src="/project12.png" alt="Project twelve" className="w-full h-56 object-cover rounded-lg mb-4" width={300} height={300}/>
              <h3 className="text-2xl text-white font-bold mb-2">Milestone 4  Responsive Web Application</h3>
              <p className="text-gray-400">Built a responsive web application with structured layout and interactive features, highlighting modern frontend development skills and practical project implementation.</p>
            </div>
          </Link>
        </div>
      </section>
